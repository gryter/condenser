...
It is strongly recommended that you store an offline copy of your password somewhere safe in case of a hard drive failure or other calamity. Consider digital offline storage (such as a flash drive or burned CD), secure cloud-based storage, as well as printed paper. Use multiple methods of storage for best redundancy. 
...
Your reputation will go up as you earn votes for your posts and comments, but it can come down if they are downvoted.
